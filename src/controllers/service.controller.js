...
async function create(req, res, next) {
    try {
        ...
        const new_service = await service_repository.create(service_request);
...
async function list(req, res, next) {
    try {
        const service_list = await service_repository.list(req.query);
...
async function getById(req, res, next) {
    try {
        const service = await service_repository.getById(req.params.id);
...
async function update(req, res, next) {
    try {
        ...
        const updated_service = await service_repository.update(service, service_request);
...
async function remove(req, res, next) {
    try {
        ...
        await service_repository.remove(service);
