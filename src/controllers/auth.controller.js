...
function AuthController({ UserRepository, AuthRepository, config, mailer, APIError }) {
    ...
    async function list(req, res, next) {
        try {
            const list_auths = await AuthRepository.list(req.query);
    ...
    async function getById(req, res, next) {
        try {
            const auth = await AuthRepository.getById(req.params.id);
